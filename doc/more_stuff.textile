...
Many languages (including Groovy) provide an interactive shell tool which allows developers to run arbitrary expressions and see the results immediately:
